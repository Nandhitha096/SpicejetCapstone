...
public class PassengerDetailsPage extends BaseClass {
	...
	public void bookFlight() throws InterruptedException {
		...
		phone.sendKeys("9843116682");
		email.sendKeys("sathyavijaykumar16@gmail.com");
		city.sendKeys("CJB");
	...
	public void passengerDetails() throws InterruptedException {
		...
		lastname.sendKeys("Arvind");
		phone.sendKeys("9877890312");
		email.sendKeys("athiyanarvin25@gmail.com");
		city.sendKeys("CJB");
		primarycustomerCheckbox.click();
		scroll();
		passenger2.click();
		NamePassenger2.sendKeys("Arvinda Bharathi");
		lastNamePassenger2.sendKeys("Stalin");
